import{n as t,Y as r,t as e,p as a,O as o,s as i}from"./DfntAQVk.js";var s=Object.defineProperty,h=Object.getOwnPropertyDescriptor,p=(t,r,e,a)=>{for(var o,i=a>1?void 0:a?h(r,e):r,p=t.length-1;p>=0;p--)(o=t[p])&&(i=(a?o(r,e,i):o(i))||i);return a&&i&&s(r,e,i),i};let l=class extends t{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var t;return r`<svg
  ...
  `,p([o({type:String,reflect:!0})],l.prototype,"size",2),p([o({type:String,reflect:!0})],l.prototype,"weight",2),p([o({type:String,reflect:!0})],l.prototype,"color",2),p([o({type:Boolean,reflect:!0})],l.prototype,"mirrored",2),l=p([i("ph-arrow-up-right")],l);export{l as PhArrowUpRight};
