import{g as e,i as t,ax as i,ar as o,b as r,s as n,T as s,a_ as a,D as c,a as d,c as l,r as u,e as p,n as h,p as g,k as m,a$ as f,h as w,j as b,W as y,C as x,b0 as v,y as $,d as k,b1 as S,l as A,b2 as R,f as T,E as C,S as E,b3 as N,R as O}from"./lucifer.v8.js";const _=e`
  div {
    width: 100%;
  }
...
`;var D=function(e,t,i,o){var r,n=arguments.length,s=n<3?t:o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,i,o);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(n<3?r(s):n>3?r(t,i,s):r(t,i))||s);return n>3&&s&&Object.defineProperty(t,i,s),s};const U={sm:"md-regular",md:"lg-regular",lg:"lg-regular"},j={success:"sealCheck",error:"warning",warning:"exclamationCircle"};let M=class extends t{constructor(){super(...arguments),this.type="success",this.size="md",this.imageSrc=void 0,this.disabled=!1,this.href="",this.text=void 0}render(){return r`
      <a
        rel="noreferrer"
        target="_blank"
        href=${this.href}
    ...
    `}imageTemplate(){return this.imageSrc?r`<wui-image src=${this.imageSrc} size="inherit"></wui-image>`:r`<wui-icon
      ...
      size="inherit"
      class="image-icon"
    ></wui-icon>`}};M.styles=[u,p,z],D([h()],M.prototype,"type",void 0),D([h()],M.prototype,"size",void 0),D([h()],M.prototype,"imageSrc",void 0),D([h({type:Boolean})],M.prototype,"disabled",void 0),D([h()],M.prototype,"href",void 0),D([h()],M.prototype,"text",void 0),M=D([d("wui-semantic-chip")],M);let V=class extends t{render(){return r`
