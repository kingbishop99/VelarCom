...
`;var R=function(e,t,o,i){var n,s=arguments.length,a=s<3?t:i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,o,i);else for(var r=e.length-1;r>=0;r--)(n=e[r])&&(a=(s<3?n(a):s>3?n(t,o,a):n(t,o))||a);return s>3&&a&&Object.defineProperty(t,o,a),a};let E=class extends i{subscribe({resetSwapState:e,initializeSwapState:t}){return()=>{n.subscribeKey("activeCaipNetwork",o=>this.onCaipNetworkChange({newCaipNetwork:o,resetSwapState:e,initializeSwapState:t})),n.subscribeChainProp("accountState",o=>{this.onCaipAddressChange({newCaipAddress:o?.caipAddress,resetSwapState:e,initializeSwapState:t})})}}constructor(){super(),this.unsubscribe=[],this.initialParams=u.state.data?.swap,this.detailsOpen=!1,this.caipAddress=n.getAccountData()?.caipAddress,this.caipNetworkId=n.state.activeCaipNetwork?.caipNetworkId,this.initialized=b.state.initialized,this.loadingQuote=b.state.loadingQuote,this.loadingPrices=b.state.loadingPrices,this.loadingTransaction=b.state.loadingTransaction,this.sourceToken=b.state.sourceToken,this.sourceTokenAmount=b.state.sourceTokenAmount,this.sourceTokenPriceInUSD=b.state.sourceTokenPriceInUSD,this.toToken=b.state.toToken,this.toTokenAmount=b.state.toTokenAmount,this.toTokenPriceInUSD=b.state.toTokenPriceInUSD,this.inputError=b.state.inputError,this.fetchError=b.state.fetchError,this.lastTokenPriceUpdate=0,this.minTokenPriceUpdateInterval=1e4,this.visibilityChangeHandler=()=>{document?.hidden?(clearInterval(this.interval),this.interval=void 0):this.startTokenPriceInterval()},this.startTokenPriceInterval=()=>{this.interval&&Date.now()-this.lastTokenPriceUpdate<this.minTokenPriceUpdateInterval||(this.lastTokenPriceUpdate&&Date.now()-this.lastTokenPriceUpdate>this.minTokenPriceUpdateInterval&&this.fetchTokensAndValues(),clearInterval(this.interval),this.interval=setInterval(()=>{this.fetchTokensAndValues()},this.minTokenPriceUpdateInterval))},this.watchTokensAndValues=()=>{this.sourceToken&&this.toToken&&(this.subscribeToVisibilityChange(),this.startTokenPriceInterval())},this.onDebouncedGetSwapCalldata=p.debounce(async()=>{await b.swapTokens()},200),this.subscribe({resetSwapState:!0,initializeSwapState:!1})(),this.unsubscribe.push(this.subscribe({resetSwapState:!1,initializeSwapState:!0}),d.subscribeKey("open",e=>{e||b.resetState()}),u.subscribeKey("view",e=>{e.includes("Swap")||b.resetValues()}),b.subscribe(e=>{this.initialized=e.initialized,this.loadingQuote=e.loadingQuote,this.loadingPrices=e.loadingPrices,this.loadingTransaction=e.loadingTransaction,this.sourceToken=e.sourceToken,this.sourceTokenAmount=e.sourceTokenAmount,this.sourceTokenPriceInUSD=e.sourceTokenPriceInUSD,this.toToken=e.toToken,this.toTokenAmount=e.toTokenAmount,this.toTokenPriceInUSD=e.toTokenPriceInUSD,this.inputError=e.inputError,this.fetchError=e.fetchError,e.sourceToken&&e.toToken&&this.watchTokensAndValues()}))}async firstUpdated(){b.initializeState(),this.watchTokensAndValues(),await this.handleSwapParameters()}disconnectedCallback(){this.unsubscribe.forEach(e=>e?.()),clearInterval(this.interval),document?.removeEventListener("visibilitychange",this.visibilityChangeHandler)}render(){return a`
    ...
    </wui-flex>`}async onSwitchTokens(){await b.switchTokens()}async onSwapPreview(){this.fetchError&&await b.swapTokens(),c.sendEvent({type:"track",event:"INITIATE_SWAP",properties:{network:this.caipNetworkId||"",swapFromToken:this.sourceToken?.symbol||"",swapToToken:this.toToken?.symbol||"",swapFromAmount:this.sourceTokenAmount||"",swapToAmount:this.toTokenAmount||"",isSmartAccount:h(n.state.activeChain)===g.ACCOUNT_TYPES.SMART_ACCOUNT}}),u.push("SwapPreview")}async handleSwapParameters(){if(this.initialParams){if(!b.state.initialized){const e=new Promise(e=>{const t=b.subscribeKey("initialized",o=>{o&&(t?.(),e())})});await e}await this.setSwapParameters(this.initialParams)}}async setSwapParameters({amount:e,fromToken:t,toToken:o}){if(!b.state.tokens||!b.state.myTokensWithBalance){const e=new Promise(e=>{const t=b.subscribeKey("myTokensWithBalance",o=>{o&&o.length>0&&(t?.(),e())});setTimeout(()=>{t?.(),e()},5e3)});await e}const i=[...b.state.tokens||[],...b.state.myTokensWithBalance||[]];if(t){const e=i.find(e=>e.symbol.toLowerCase()===t.toLowerCase());e&&b.setSourceToken(e)}if(o){const e=i.find(e=>e.symbol.toLowerCase()===o.toLowerCase());e&&b.setToToken(e)}e&&!isNaN(Number(e))&&b.setSourceTokenAmount(e)}onCaipAddressChange({newCaipAddress:e,resetSwapState:t,initializeSwapState:o}){this.caipAddress!==e&&(this.caipAddress=e,t&&b.resetState(),o&&b.initializeState())}onCaipNetworkChange({newCaipNetwork:e,resetSwapState:t,initializeSwapState:o}){this.caipNetworkId!==e?.caipNetworkId&&(this.caipNetworkId=e?.caipNetworkId,t&&b.resetState(),o&&b.initializeState())}};E.styles=D,R([o({type:Object})],E.prototype,"initialParams",void 0),R([t()],E.prototype,"interval",void 0),R([t()],E.prototype,"detailsOpen",void 0),R([t()],E.prototype,"caipAddress",void 0),R([t()],E.prototype,"caipNetworkId",void 0),R([t()],E.prototype,"initialized",void 0),R([t()],E.prototype,"loadingQuote",void 0),R([t()],E.prototype,"loadingPrices",void 0),R([t()],E.prototype,"loadingTransaction",void 0),R([t()],E.prototype,"sourceToken",void 0),R([t()],E.prototype,"sourceTokenAmount",void 0),R([t()],E.prototype,"sourceTokenPriceInUSD",void 0),R([t()],E.prototype,"toToken",void 0),R([t()],E.prototype,"toTokenAmount",void 0),R([t()],E.prototype,"toTokenPriceInUSD",void 0),R([t()],E.prototype,"inputError",void 0),R([t()],E.prototype,"fetchError",void 0),R([t()],E.prototype,"lastTokenPriceUpdate",void 0),E=R([l("w3m-swap-view")],E);const L=e`
  :host > wui-flex:first-child {
    overflow-y: auto;
    overflow-x: hidden;
    scrollbar-width: none;
