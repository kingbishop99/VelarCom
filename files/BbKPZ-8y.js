import{c as e,n as t,D as i,i as o,s as r,ar as s,az as a,R as n,p as c,b as l,aA as d,l as u,aB as h,A as p,a as m,aC as g,y as w,k as v,C as f,aD as b,E as y,aE as x,S as C,aF as $,ax as E,T as P}from"./lucifer.v8.js";const S=e`
  :host {
...
`;var k=function(e,t,i,o){var r,s=arguments.length,a=s<3?t:o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,o);else for(var n=e.length-1;n>=0;n--)(r=e[n])&&(a=(s<3?r(a):s>3?r(t,i,a):r(t,i))||a);return s>3&&a&&Object.defineProperty(t,i,a),a};let L=class extends o{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=r.state.connectors,this.authConnector=this.connectors.find(e=>"AUTH"===e.type),this.remoteFeatures=s.state.remoteFeatures,this.isPwaLoading=!1,this.hasExceededUsageLimit=a.state.plan.hasExceededUsageLimit,this.unsubscribe.push(r.subscribeKey("connectors",e=>{this.connectors=e,this.authConnector=this.connectors.find(e=>"AUTH"===e.type)}),s.subscribeKey("remoteFeatures",e=>this.remoteFeatures=e))}connectedCallback(){super.connectedCallback(),this.handlePwaFrameLoad()}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){let e=this.remoteFeatures?.socials||[];const t=Boolean(this.authConnector),i=e?.length,o="ConnectSocials"===n.state.view;return t&&i||o?(o&&!i&&(e=c.DEFAULT_SOCIALS),l` <wui-flex flexDirection="column" gap="2">
      ${e.map(e=>l`<wui-list-social
          ...
          ></wui-list-social>`)}
    </wui-flex>`):null}async onSocialClick(e){this.hasExceededUsageLimit?n.push("UsageExceeded"):e&&await d(e)}async handlePwaFrameLoad(){if(u.isPWA()){this.isPwaLoading=!0;try{this.authConnector?.provider instanceof h&&await this.authConnector.provider.init()}catch(e){p.open({displayMessage:"Error loading embedded wallet in PWA",debugMessage:e.message},"error")}finally{this.isPwaLoading=!1}}}};L.styles=S,k([t()],L.prototype,"tabIdx",void 0),k([i()],L.prototype,"connectors",void 0),k([i()],L.prototype,"authConnector",void 0),k([i()],L.prototype,"remoteFeatures",void 0),k([i()],L.prototype,"isPwaLoading",void 0),k([i()],L.prototype,"hasExceededUsageLimit",void 0),L=k([m("w3m-social-login-list")],L);const R=e`
  wui-flex {
...
`;var I=function(e,t,i,o){var r,s=arguments.length,a=s<3?t:o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,o);else for(var n=e.length-1;n>=0;n--)(r=e[n])&&(a=(s<3?r(a):s>3?r(t,i,a):r(t,i))||a);return s>3&&a&&Object.defineProperty(t,i,a),a};let A=class extends o{constructor(){super(),this.unsubscribe=[],this.checked=g.state.isLegalCheckboxChecked,this.unsubscribe.push(g.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){const{termsConditionsUrl:e,privacyPolicyUrl:t}=s.state,i=s.state.features?.legalCheckbox,o=Boolean(e||t)&&Boolean(i)&&!this.checked,r=o?-1:void 0;return l`
      ...
      >
        <w3m-social-login-list tabIdx=${w(r)}></w3m-social-login-list>
      </wui-flex>
...
`;var F=function(e,t,i,o){var r,s=arguments.length,a=s<3?t:o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,o);else for(var n=e.length-1;n>=0;n--)(r=e[n])&&(a=(s<3?r(a):s>3?r(t,i,a):r(t,i))||a);return s>3&&a&&Object.defineProperty(t,i,a),a};let W=class extends o{constructor(){super(),this.unsubscribe=[],this.timeout=void 0,this.socialProvider=v.getAccountData()?.socialProvider,this.uri=v.getAccountData()?.farcasterUrl,this.ready=!1,this.loading=!1,this.remoteFeatures=s.state.remoteFeatures,this.authConnector=r.getAuthConnector(),this.forceUpdate=()=>{this.requestUpdate()},this.unsubscribe.push(v.subscribeChainProp("accountState",e=>{this.socialProvider=e?.socialProvider,this.uri=e?.farcasterUrl,this.connectFarcaster()}),s.subscribeKey("remoteFeatures",e=>{this.remoteFeatures=e})),window.addEventListener("resize",this.forceUpdate)}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this.timeout),window.removeEventListener("resize",this.forceUpdate);!v.state.activeCaipAddress&&this.socialProvider&&(this.uri||this.loading)&&y.sendEvent({type:"track",event:"SOCIAL_LOGIN_CANCELED",properties:{provider:this.socialProvider}})}render(){return this.onRenderProxy(),l`${this.platformTemplate()}`}platformTemplate(){return u.isMobile()?l`${this.mobileTemplate()}`:l`${this.desktopTemplate()}`}desktopTemplate(){return this.loading?l`${this.loadingTemplate()}`:l`${this.qrTemplate()}`}qrTemplate(){return l` <wui-flex
      flexDirection="column"
      alignItems="center"
      .padding=${["0","5","5","5"]}
      gap="5"
