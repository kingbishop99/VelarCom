import{c as e,r as t,e as i,n as o,i as r,b as s,a,k as n,S as c,z as l,T as d,U as u,y as w,j as p,W as h,R as m,l as f,D as g}from"./lucifer.v8.js";const k=e`
  button {
    width: 100%;
    display: flex;
    align-items: center;
...
`;var b=function(e,t,i,o){var r,s=arguments.length,a=s<3?t:o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,o);else for(var n=e.length-1;n>=0;n--)(r=e[n])&&(a=(s<3?r(a):s>3?r(t,i,a):r(t,i))||a);return s>3&&a&&Object.defineProperty(t,i,a),a};let y=class extends r{constructor(){super(...arguments),this.networkImages=[""],this.text=""}render(){return s`
    ...
    </wui-flex>`}};y.styles=[t,i,k],b([o({type:Array})],y.prototype,"networkImages",void 0),b([o()],y.prototype,"text",void 0),y=b([a("wui-compatible-network")],y);const x=e`
