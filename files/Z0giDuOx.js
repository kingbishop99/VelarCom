import{n as t,Y as r,t as e,p as a,O as l,s as o}from"./DfntAQVk.js";var i=Object.defineProperty,s=Object.getOwnPropertyDescriptor,h=(t,r,e,a)=>{for(var l,o=a>1?void 0:a?s(r,e):r,h=t.length-1;h>=0;h--)(l=t[h])&&(o=(a?l(r,e,o):l(o))||o);return a&&o&&i(r,e,o),o};let p=class extends t{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var t;return r`<svg
  ...
  `,h([l({type:String,reflect:!0})],p.prototype,"size",2),h([l({type:String,reflect:!0})],p.prototype,"weight",2),h([l({type:String,reflect:!0})],p.prototype,"color",2),h([l({type:Boolean,reflect:!0})],p.prototype,"mirrored",2),p=h([o("ph-arrow-right")],p);export{p as PhArrowRight};
