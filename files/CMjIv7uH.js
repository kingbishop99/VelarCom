import{n as t,Y as e,t as r,p as a,O as o,s as l}from"./DfntAQVk.js";var i=Object.defineProperty,s=Object.getOwnPropertyDescriptor,p=(t,e,r,a)=>{for(var o,l=a>1?void 0:a?s(e,r):e,p=t.length-1;p>=0;p--)(o=t[p])&&(l=(a?o(e,r,l):o(l))||l);return a&&l&&i(e,r,l),l};let h=class extends t{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var t;return e`<svg
  ...
  `,p([o({type:String,reflect:!0})],h.prototype,"size",2),p([o({type:String,reflect:!0})],h.prototype,"weight",2),p([o({type:String,reflect:!0})],h.prototype,"color",2),p([o({type:Boolean,reflect:!0})],h.prototype,"mirrored",2),h=p([l("ph-envelope")],h);export{h as PhEnvelope};
